    ...
    <div class="container-fluid">
        <div>
            <ul class="nav navbar-nav">
                <li><a href="${path}/article/news_recommend" style="color: aliceblue;">推荐</a></li>
                <li><a href="${path}/article/news_hot" style="color: aliceblue;">热点</a></li>
                <li><a href="${path}/article/news_tech" style="color: aliceblue;">科技</a></li>
                <li><a href="${path}/article/news_funny" style="color: aliceblue;">搞笑</a></li>
                <li><a href="${path}/article/news_entertainment" style="color: aliceblue;">娱乐</a></li>
                <li><a href="${path}/article/news_game" style="color: aliceblue;">游戏</a></li>
                <li><a href="${path}/article/news_sports" style="color: aliceblue;">体育</a></li>
                <li><a href="${path}/article/news_cartoon" style="color: aliceblue;">动漫</a></li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu text-center" style="min-width:100%;">
                        <li><a href="${path}/article/news_movie">电影</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="${path}/article/news_automobile">汽车</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="${path}/article/news_military">军事</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="${path}/article/news_story">故事</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="${path}/article/news_finance">财经</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="${path}/article/essay_joke">段子</a></li>
                    </ul>
                </li>
            </ul>
            <ul class="nav navbar-nav" style="float: right">
                <c:if test="${empty sessionScope.sessionUser}">
                    <li>
                        <a href="${path}/user/login" style="color: aliceblue;">登录</a>
                    </li>
                    <li><a href="${path}/user/register" style="color: aliceblue;">注册</a></li>
                </c:if>
                <c:if test="${!empty sessionScope.sessionUser}">
                    ...
                    <li><a href="${path}/write" style="color: aliceblue;">发文</a></li>
                </c:if>
    ...
    <div class="row">
        <div class="col-xs-2" style="padding-left: 30px;">
            <div class="left-nav text-center">
                <ul style="list-style-type:none;padding: 0px;">
                    ...
                    <li style="margin-bottom: 5px;">
                        <a href="${path}" style="color: #606060"><span class="glyphicon glyphicon glyphicon glyphicon-home" aria-hidden="true"><b>返回首页</b></span></a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="col-xs-7">
            <div class="article-box">
                ...
                <div class="article-comment">
                    <form id="comment-form" method="post" action="${path}/articleComment?artId=${requestScope.article.id}">
                        ...
                        <div>
                            ...
                            <button id="comment-submit" style="float: right;" type="submit" class="btn btn-primary btn-lg">发表评论</button>
                        </div>
                    </form>
                    <ul class="comment-container">
                        <c:forEach var="comment" items="${requestScope.commentList}">
                            <li class="comment-list">
                                <div class="user-info">
                                    <img class="user-img img-circle" src="${path}/${applicationScope.headPicPath}/${comment.user.picName}">&nbsp;<span class="user-name">${comment.user.nickname}</span>&nbsp;&nbsp;
        ...
        <div class="col-xs-3">
            <div class="editor-info">
                <img src="${path}/${applicationScope.headPicPath}/${requestScope.article.user.picName}" alt="???" class="img-circle editor-pic">
    ...
    function praise() {
        $.ajax({
            ...
            success:function (data) {
                if(data === "login"){
                    $("#prompt").html('请先<a href="${path}/user/login" target="_blank">登录</a>后才能点赞！');
