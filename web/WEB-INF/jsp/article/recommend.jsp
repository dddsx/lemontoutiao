        ...
        <div class="col-xs-2">
            <div class="left-nav text-center">
                <ul class="nav nav-pills nav-stacked">
                    <li role="presentation" class="active"><a category="1" href="${path}/article/news_recommend"><span class="chose">推荐</span></a></li>
                                ...
                                <div class="picture">
                                    <c:choose>
                                        <c:when test="${fn:startsWith(article.picture, 'http')}">
                                            <a href="${path}/view/${article.id}" target="_blank"><img class="img-rounded cover-img" src="${article.picture}"></a>
                                        </c:when>
                                        <c:otherwise>
                                            <a href="${path}/view/${article.id}" target="_blank"><img class="img-rounded cover-img" src="${path}/${article.picture}"></a>
                                        </c:otherwise>
                                    </c:choose>
                                </div>
                            </td>
